...
public class zombieBGmovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        visionRadius = 1.5f * scaleFactor;
        speed = 1.2f * scaleFactor;
        waitTime = 2f;
    ...
    void LoadAnimations()
    {
        ...
        {
            Resources.Load<Sprite>("zumbi/spr_zombiebgdown1"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgdown2"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgdown3")
        };

        anims["up"] = new Sprite[]
        {
            Resources.Load<Sprite>("zumbi/spr_zombiebgup1"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgup2"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgup3")
        };

        anims["left"] = new Sprite[]
        {
            Resources.Load<Sprite>("zumbi/spr_zombiebgleft1"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgleft2"),
            Resources.Load<Sprite>("zumbi/spr_zombiebgleft3")
        };
    }
